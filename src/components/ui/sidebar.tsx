    ...
    >
      <TooltipProvider>
        <div
          ...
          style={
            {
              "--sidebar-width": SIDEBAR_WIDTH_DESKTOP,
...
// Main Sidebar Component for the app
interface SidebarProps {
  className?: string;
  playlists: any[];
}

export function MainSidebar({ className, playlists }: SidebarProps) {
